...
public class AppConfig {
    ...
    public UserService userService(final UserRepository userRepository,
        ...
        return new UserServiceImpl(userRepository, passwordEncoder,locationRepository);
    }
    
    @Bean
    public LocationService locationService(final UserRepository userRepository,
                                           final LocationRepository locationRepository){
        return new LocationServiceImpl(userRepository,locationRepository);
    }
